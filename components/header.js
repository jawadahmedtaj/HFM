  ...
  return (
    <header className="bg-[#161616]">
      <div className="mx-auto container">
        <div className="items-center grid grid-flow-row xl:grid-flow-col min-h-[132px] text-[#EEEEEE]">
          <div className="justify-center xl:justify-start grid grid-flow-row">
          ...
          <div className="grid grid-flow-col pb-8 self-end pt-8 xl:pt-0">
          ...
          <div className="gap-4 grid grid-flow-row py-4 lg:place-self-start place-self-center">
